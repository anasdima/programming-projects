...
public class Utilities
{
  ...
  // TODO
  public static double getDistance (int x1, int y1, int x2, int y2)	// Calculates the distance between two points in the map
  {
  ...
  // TODO
  public static double getDistance (Unit a, Unit b)	// Calculates the distance between two units
  {
	  return getDistance(a.getX(),a.getY(),b.getX(),b.getY());  // Using the getDistance function to calculate the distance between two units.
