// Ονοματεπώνυμο : Δημανίδης Τασός
// ΑΕΜ 			 : 7422
// Τηλέφωνο		 : 6982023258
// Email		 : anasdima@auth.gr

// Ονοματεπώνυμο : Δοξόπουλος Παναγιώτης
// ΑΕΜ			 : 7601
// Τηλέφωνο		 : 6976032566
...
public class MainPlatform
{
  ...
  private static String[] teamNames = {  "Heuristic Player","SimpleDefensive", "OneLaneOffensive", "MultiLaneOffensive", "Random Player" };
  private static String[] teamClasses = { "Player.HeuristicPlayer", "Player.SimpleDefensive","Player.OneLaneOffensive", "Player.MultiLaneOffensive", 
	  										"Player.RandomPlayer" };
