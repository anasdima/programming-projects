                    ...
                    if child['type'] == 'Background':
                        ...
                        for step in child['steps']:
                            ...
                            if not in_step == 'Given':
                                nlp_ready_resources[resource][child['name']][in_step].append({'sentence':sentence,'data_table':data_table})
                            else:
                                nlp_ready_resources[resource][child['name']][in_step].append({'sentence':sentence})
